    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "My API", Version = "v1", Description = "【0912 V4】 1）修改article接口 2）修改account关注接口 3）Topic接口添加搜索 4)修改Favourite接口 5)修改topic 6）修改photo" });
                // ��ȡxml�ļ���
